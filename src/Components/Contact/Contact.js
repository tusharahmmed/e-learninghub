                ...
                <div className="mt-8 overflow-hidden">
                    <div className="grid grid-cols-1 md:grid-cols-2">
                        <div className="p-6 mr-2 bg-gray-100 dark:bg-gray-800 sm:rounded-lg">
                            <h1 className="text-4xl sm:text-5xl text-gray-700 dark:text-white font-bold tracking-tight">
                                Get in touch
                            </h1>
                            <p className="text-normal text-lg sm:text-1xl font-medium text-gray-500 dark:text-gray-400 mt-2">
